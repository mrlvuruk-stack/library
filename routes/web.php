...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile', [dashboardController::class, 'profile_view'])->name('profile.view');
    ...
    Route::post('/book/import', [BookController::class, 'import_csv'])->name('book.import');
    Route::get('/book/import/sample', [BookController::class, 'download_sample'])->name('book.import.sample');
    ...
    Route::post('/student/import', [StudentController::class, 'import_csv'])->name('student.import');
    Route::get('/student/import/sample', [StudentController::class, 'download_sample'])->name('student.import.sample');
    ...
    Route::get('/reports/Date-Wise/export', [ReportsController::class, 'export_date_wise'])->name('reports.date_wise_export');
    ...
    Route::get('/reports/monthly-Wise/export', [ReportsController::class, 'export_month_wise'])->name('reports.month_wise_export');
    
    Route::get('/reports/not-returned', [ReportsController::class, 'not_returned'])->name('reports.not_returned');
    Route::get('/reports/not-returned/export', [ReportsController::class, 'export_not_returned'])->name('reports.not_returned_export');
