                    ...
                    <form class="yourform" action="{{ route('student.update', $student->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control" required>
                                ...
                                <option value="Regular" {{ $student->category == 'Regular' ? 'selected' : '' }}>Regular</option>
                                <option value="Scholarship" {{ $student->category == 'Scholarship' ? 'selected' : '' }}>Scholarship</option>
                            </select>
                            @error('category')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="photo" id="cropped-image-data">
                            <div class="mt-3 text-center">
                                <div class="d-inline-block position-relative">
                                    <img id="avatar-preview" src="{{ $student->photo ? asset('images/' . $student->photo) : asset('images/avatar.png') }}" 
