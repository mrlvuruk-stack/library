                        ...
                        <tbody>
                            @forelse ($authors as $author)
                                <tr>
                                    <td>{{ $author->id }}</td>
                                    <td>
                                        <a href="#" class="author-name-link" onclick="event.preventDefault(); openAuthorModal({{ $author->id }})">
                                            {{ $author->name }}
                                        </a>
                                    </td>
                                    <td class="edit">
                                ...
                                <div class="custom-modal-overlay" id="authorModal-{{ $author->id }}">
                                    <div class="custom-modal-card">
                                        <div class="modal-card-header">
                                            <h3 class="modal-card-title">{{ $author->name }} - Works Profile</h3>
                                            <button class="modal-close-btn" onclick="closeAuthorModal({{ $author->id }})">&times;</button>
                                        </div>
                                            ...
                                            <div class="type-grid">
                                                ...
                                                <div class="type-section">
                                                    ...
                                                    <ul class="work-list">
                                                        ...
                                                        @empty
                                                            <li class="no-works">No books registered</li>
                                                        @endforelse
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="type-section">
                                                    ...
                                                    <ul class="work-list">
                                                        ...
                                                        @empty
                                                            <li class="no-works">No stories registered</li>
                                                        @endforelse
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="type-section">
                                                    ...
                                                    <ul class="work-list">
                                                        ...
                                                        @empty
                                                            <li class="no-works">No poems registered</li>
                                                        @endforelse
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="type-section">
                                                    ...
                                                    <ul class="work-list">
                                                        ...
                                                        @empty
                                                            <li class="no-works">No blogs registered</li>
                                                        @endforelse
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="type-section">
                                                    ...
                                                    <ul class="work-list">
                                                        ...
                                                        @empty
                                                            <li class="no-works">No articles registered</li>
                                                        @endforelse
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="type-section">
                                                    ...
                                                    <ul class="work-list">
                                                        ...
                                                        @empty
                                                            <li class="no-works">No research papers registered</li>
                                                        @endforelse
                                                    </ul>
                                                </div>
                                            </div>
...
<script>
    function openAuthorModal(id) {
        const modal = document.getElementById('authorModal-' + id);
        if (modal) {
